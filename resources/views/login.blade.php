...
<div class="register login-background">

    <div class="container create-account">
        <div class="row align-items-center d-flex justify-content-center">
            <h2 class="create-account-text">LOG IN</h2>
        </div>
        ...
        <div class="row align-items-center d-flex justify-content-center">
            <div class="col-md-5 form-container">
                <form action="register.blade.php" method="POST">
                    ...
                    <p class="have-account">No Account?</p>
                    <p class="login-switch"><a href="register.blade.php"><b>Register now</b></a></p>

                </form>
            </div>

            <div class="col-md-6 create-account-img offset-md-1 d-none d-md-block">
                <img src="img/profile_urahara.jpg" alt="account">
            </div>
        </div>

        <div class="row d-flex justify-content-center">
                <button type="submit" class="create-account-button btn-primary btn-block">LOG IN</button>
        </div>
