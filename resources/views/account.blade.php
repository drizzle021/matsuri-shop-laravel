    ...
    <div class="account">
        <div class="container-fluid bg-dark account-box">
                        ...
                        <div class="row no-margin">
                            ...
                            <div class="offset-md-1 col-md-4 no-padding">
                                ...
                                <div class="row form-group">
                                    ...
                                    <input type="text" class="form-control" id="email" placeholder="mail@example.com" required minlength="10" disabled>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="matsuri-points">1234 points</div>
                                </div>
                                <div class="row form-group">
                                    <h3 class="no-padding"><b>Preferred Payment Method</b></h3>
                                    <select name="category-select" class="category-select" id="category" autocomplete="off">
            ...
            <div class="row d-flex justify-content-center">
                <button type="submit" class="update-account-button btn-primary btn-block">UPDATE</button>
            </div>
            <div class="row d-flex justify-content-center">
                <button type="submit" class="logout-button btn-primary btn-block">LOGOUT</button>
            </div>
        </div>
